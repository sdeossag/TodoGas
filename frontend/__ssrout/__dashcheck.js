...
async function main() {
  ...
  const apiClient = (await import("./assets/client-xYrMAKmr.js")).default;
  const DashboardPage = (await import("./assets/DashboardPage-TKUyR9Gy.js")).default;
  const MOCKS = {
    "/api/dashboard/": {
      ...
      assets_without_maintenance: [
        {
          asset_id: "a1",
          asset_name: "Central de oxigeno",
          asset_code: "OX-01",
          hospital_name: "Hospital San Juan",
          days_since_last_pm: 143
        },
        {
          asset_id: "a2",
          asset_name: "Compresor aire medicinal",
          asset_code: "AM-02",
          hospital_name: "Clinica Norte",
          days_since_last_pm: null
        }
      ]
    },
    "/api/dashboard/compliance-history/": [
      { percentage: 91.7, completed: 11, generated: 12, month: "2025-09" },
      { percentage: 0, completed: 0, generated: 0, month: "2025-10" },
      { percentage: 42, completed: 4, generated: 10, month: "2025-11" },
      { percentage: 66.7, completed: 6, generated: 9, month: "2025-12" },
      { percentage: 100, completed: 5, generated: 5, month: "2026-01" },
      { percentage: 80, completed: 8, generated: 10, month: "2026-02" },
      { percentage: 55, completed: 11, generated: 20, month: "2026-03" },
      { percentage: 30, completed: 3, generated: 10, month: "2026-04" },
      { percentage: 95, completed: 19, generated: 20, month: "2026-05" },
      { percentage: 0, completed: 0, generated: 0, month: "2026-06" },
      { percentage: 72, completed: 18, generated: 25, month: "2026-07" },
  ...
  apiClient.defaults.adapter = async (config) => {
    ...
    if (data === void 0) throw new Error(`URL sin mock: ${config.url}`);
  ...
  const xTicks = [...document.querySelectorAll(".recharts-xAxis .recharts-cartesian-axis-tick-value")].map((t) => t.textContent);
  const yTicks = [...document.querySelectorAll(".recharts-yAxis .recharts-cartesian-axis-tick-value")].map((t) => t.textContent);
  ...
  document.querySelector(".recharts-bar");
  console.log(
    "clases de eje :",
    [...new Set([...document.querySelectorAll("svg *")].map((n) => n.getAttribute("class")).filter(Boolean))].filter((c) => c.includes("axis")).join(" / ")
  );
